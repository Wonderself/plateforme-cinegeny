...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-[#C9A227]/15 data-[state=active]:text-[#C9A227]',
      'data-[state=active]:border data-[state=active]:border-[#C9A227]/20',
      'data-[state=active]:shadow-[0_0_12px_rgba(201,162,39,0.1)]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'mt-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A227]/50',
      className
    )}
    {...props}
  />
